...
export const TRANSLATIONS: Record<Language, Record<string, string>> = {
  en: {
    ...
    xpAwardedBadge: '+{xp} XP Awarded',
    criteriaMet: 'Criteria Met:',
    collectRewardBtn: 'Collect Reward & Continue',
  ...
  ta: {
    ...
    lockedChallenge: 'பூட்டப்பட்ட சவால்',
    badgeUnlocked: 'விருது திறக்கப்பட்டது!',
    xpAwardedBadge: '+{xp} XP வழங்கப்பட்டது',
    criteriaMet: 'நிபந்தனை பூர்த்தி:',
    collectRewardBtn: 'பரிசைப் பெற்று தொடர்க',
  ...
  hi: {
    ...
    lockedChallenge: 'लॉक्ड चुनौती',
    badgeUnlocked: 'बैज अनलॉक हुआ!',
    xpAwardedBadge: '+{xp} XP प्रदान किया गया',
    criteriaMet: 'शर्त पूरी हुई:',
    collectRewardBtn: 'पुरस्कार प्राप्त करें और जारी रखें',
